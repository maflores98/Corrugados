    ...
    var createDigits = function(where) 
    {
        ...
        for (var i = 0; i < options.startTime.length; i++)
        {
            if (parseInt(options.startTime[i]) >= 0) 
            {
                ...
                // Añadir dígitos máximo, por ejemplo, el primer dígito de minutos (mm) tiene
                // Un máximo de 5. Condicional max se utiliza cuando el dígito de la izquierda tiene un alcance
                // Máximo. Por ejemplo segundo "hora" dígito tiene un máximo de 4 condicional
